...
$sql2="Select * from cat2 where title='".$product."'";
...
?>
  ...
  <tr>
    <td>Capacitate de uscare (kg)</td>
    <td><?php echo "${row2['capacitateuscare']}";?></td>
  </tr>
  <tr>
    <td>CCapacitate rezervor (l)</td>
    <td><?php echo "${row2['capacitaterezervor']}";?></td>
  </tr>
</table>
...
<table class="tab3" border="1">
  ...
  <tr>
    ...
    <td width="230px"><?php echo "${row2['dimensiuni']}";?></td>
  </tr>
</table>
  ...
  <tr>
    <td>Consum energetic la uscare (kWh/ciclu)</td>
