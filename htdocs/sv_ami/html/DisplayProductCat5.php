...
$sql2="Select * from cat5 where title='".$product."'";
...
?>
  ...
  <tr>
    <td>Tip aparat</td>
    <td><?php echo "${row2['tip']}";?></td>
  </tr>
            <tr>
    <td>Capacitate (l)</td>
    <td><?php echo "${row2['capacitate']}";?></td>
  </tr>
  <tr>
    <td height="70%">Tehnologii</td>
    <td  width="150px"><?php echo "${row2['tehnologii']}";?></td>
  </tr>
</table>
...
<b><p class="p3">Caracteristici tehnice</p><b>
<table class="tab3" border="1">
  <tr>
    <td>Putere</td>
    <td><?php echo "${row2['putere']}";?></td>
  </tr>
  <tr>
    <td>Consum de energie (kWh)</td>
    <td><?php echo "${row2['consumenergie']}";?></td>
  </tr>
    <tr>
    <td>Clasa de eficienta energetica</td>
    <td><?php echo "${row2['clasaenergetica']}";?></td>
  </tr>
</table>
    
    <b><p class="p4">Altele</p><b>
<table class="tab4" border="1">
  ...
  <tr>
    <td width="230px">Dimensiuni (L x A x I cm)</td>
    <td width="230px"><?php echo "${row2['dimensiune']}";?></td>
  </tr>
</table>
