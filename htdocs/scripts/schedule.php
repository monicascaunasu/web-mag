...
<!--                             <li><a href="./gallery.html">Tiredful Api</a></li> -->
 ...
 <div class="prod" >
      ...
      <!--  <font color="black">Pret:1500 euro</font>
            <form action='#' method='POST'><button type='submit' name='orderid' value='product1' class='btn-link' formaction='./addToCart.php'>Adauga in cos</button></form>-->
 ...
 <div class="prod" >
        ...
        <!--<font color="black">Pret:2000 euro</font>
            <form action='#' method='POST'><button type='submit' name='orderid' value='product2' class='btn-link' formaction='./addToCart.php'>Adauga in cos</button></form>-->
		</div>
